...
%
% Output:
% Markers            3D-marker data [NvideoFrames x Nmarkers x Ndim(=3)]
...
% CameraInfo         MarkerRelated CameraInfo [NvideoFrames x Nmarkers]
% ResidualError      MarkerRelated ErrorInfo  [NvideoFrames x Nmarkers]
